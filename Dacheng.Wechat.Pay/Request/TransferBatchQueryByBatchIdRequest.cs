...
/// 通过微信批次单号查询批次单
/// </summary>
public class TransferBatchQueryByBatchIdRequest : WechatPayRequestBase<TransferBatchQueryResponse>
{
    /// <summary>
    /// 请求方式
    /// </summary>
    ...
    /// 接口名称
    /// </summary>
    public override string Api => $"/v3/transfer/batches/batch-id/{BatchId}" +
